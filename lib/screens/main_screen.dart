...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => MainViewModel()..loadCat(),
        ...
        child: vm.loading
            ...
            : vm.error != null && cat == null
                ...
                : cat == null
                    ...
                    : _mainUI(context, vm, cat),
      ),
    );
  }

  Widget _mainUI(BuildContext context, MainViewModel vm, cat) {
    return Column(
      children: [
